...
<div class="bg">
   <b-container>
    <b-row style="height: 100vh">
      <b-col class="text-center">Otro</b-col>
      <b-col class="m-auto fo" cols="12" md="4">
        ...
        <b-button @click="login" variant="success" class="me-3 lim"
          >Ingresar</b-button
        >
        <b-button @click="limpiar" variant="outline-primary" class="agr-ju">Limpiar</b-button>
      </b-col>
    </b-row>
  </b-container>
</div>
